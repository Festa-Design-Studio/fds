...
@section('title', 'Edit Industry - Festa Design Studio')

@section('header_title', 'Edit Industry')
  ...
  <form method="POST" action="{{ route('admin.industries.update', $industry->id) }}">
    ...
    <div class="space-y-4">
      ...
      <div class="pt-4 flex space-x-4">
        ...
        <form action="{{ route('admin.industries.destroy', $industry->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this industry?');" class="inline">
          @csrf
          @method('DELETE')
