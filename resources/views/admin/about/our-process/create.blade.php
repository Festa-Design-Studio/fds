...
@section('title', 'Create Process Item')

@section('header_title', 'Create Process Item')

@section('content')
<div class="p-8 max-w-4xl mx-auto bg-white-smoke-100 rounded-lg shadow-sm">
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-h3 font-bold text-the-end-900">Create New Process Item</h1>
        <p class="text-body text-the-end-700 mt-2">Add a new philosophy principle, methodology step, or impact metric</p>
    </div>

    {{-- Form --}}
    <form action="{{ route('admin.about.our-process.store') }}" method="POST" class="space-y-8">
        @csrf
