        ...
        <div class="bg-white border border-white-smoke-300 p-6 rounded-xl shadow-sm">
            ...
            <div class="space-y-6 mb-8">
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Brief description for search engines (150-160 characters recommended)...">{{ old('meta_description', $service->meta_description) }}</x-core.textarea>
                
                <x-core.textarea 
                    name="meta_keywords" 
                    label="Meta Keywords" 
                    rows="2"
                    placeholder="keyword1, keyword2, keyword3...">{{ old('meta_keywords', $service->meta_keywords) }}</x-core.textarea>
            </div>
            ...
            <div class="space-y-6 mb-8">
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Description for social media sharing...">{{ old('og_description', $service->og_description) }}</x-core.textarea>
            ...
            <div class="space-y-6">
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Description for Twitter sharing...">{{ old('twitter_description', $service->twitter_description) }}</x-core.textarea>
                
                <x-core.text-input 
                    name="twitter_image" 
                    label="Twitter Image URL" 
                    value="{{ old('twitter_image', $service->twitter_image) }}"
