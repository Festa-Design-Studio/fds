        ...
        <div class="bg-white border border-white-smoke-300 p-6 rounded-xl shadow-sm">
            ...
            <div class="space-y-6 mb-8">
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Brief description for search engines (150-160 characters recommended)...">{{ old('meta_description', $sector->meta_description) }}</x-core.textarea>
                
                <x-core.textarea 
                    name="meta_keywords" 
                    label="Meta Keywords" 
                    rows="2"
                    placeholder="keyword1, keyword2, keyword3...">{{ old('meta_keywords', $sector->meta_keywords) }}</x-core.textarea>
            </div>
            ...
            <div class="space-y-6 mb-8">
                ...
                <x-core.text-input 
                    name="og_title" 
                    label="OG Title" 
                    value="{{ old('og_title', $sector->og_title) }}"
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Description for social media sharing...">{{ old('og_description', $sector->og_description) }}</x-core.textarea>
                
                <x-core.text-input 
                    name="og_image" 
                    label="OG Image URL" 
                    value="{{ old('og_image', $sector->og_image) }}"
            ...
            <div class="space-y-6">
                ...
                <x-core.text-input 
                    name="twitter_title" 
                    label="Twitter Title" 
                    value="{{ old('twitter_title', $sector->twitter_title) }}"
                ...
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Description for Twitter sharing...">{{ old('twitter_description', $sector->twitter_description) }}</x-core.textarea>
                
                <x-core.text-input 
                    name="twitter_image" 
                    label="Twitter Image URL" 
                    value="{{ old('twitter_image', $sector->twitter_image) }}"
        ...
        <div class="bg-white border border-white-smoke-300 p-6 rounded-xl shadow-sm">
            ...
            <div class="mt-6">
                <x-core.textarea 
                    ...
                    rows="3"
                    placeholder="Basic page description...">{{ old('description', $sector->description) }}</x-core.textarea>
            </div>
        </div>
