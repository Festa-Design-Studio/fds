        ...
        @if(!$simplified)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12">
                ...
                <div class="flex flex-col space-y-4 max-w-72">
                    ...
                    <p class="text-body-sm text-the-end-700">Empowering social impact organizations through thoughtful design that amplifies their mission and drives meaningful change.</p>
