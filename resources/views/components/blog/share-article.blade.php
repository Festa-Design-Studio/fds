        ...
        <div class="flex space-x-1.5">
            ...
            <button type="button" class="p-1 text-the-end-400 hover:text-pepper-green-600" 
                onclick="navigator.clipboard.writeText('{{ $url }}').then(() => { 
                    this.innerHTML = `<svg class='w-5 h-5 fill-pepper-green-600' viewBox='0 0 48 48'><title>Copied!</title><g><path fill-rule='evenodd' clip-rule='evenodd' d='M34 28C34 31.3137 31.3137 34 28 34L10 34C6.68629 34 4 31.3137 4 28L4 10C4 6.68629 6.68629 4 10 4L28 4C31.3137 4 34 6.68629 34 10L34 28Z'></path><path d='M38 44C41.3137 44 44 41.3137 44 38L44 20C44 16.6863 41.3137 14 38 14L37 14L37 29C37 33.4183 33.4183 37 29 37L14 37L14 38C14 41.3137 16.6863 44 20 44L38 44Z'></path></g></svg>`; setTimeout(() => { this.innerHTML = `<svg class='w-5 h-5 fill-the-end-400 hover:fill-pepper-green-600' viewBox='0 0 48 48'><title>Copy link</title><g><path fill-rule='evenodd' clip-rule='evenodd' d='M34 28C34 31.3137 31.3137 34 28 34L10 34C6.68629 34 4 31.3137 4 28L4 10C4 6.68629 6.68629 4 10 4L28 4C31.3137 4 34 6.68629 34 10L34 28Z'></path><path d='M38 44C41.3137 44 44 41.3137 44 38L44 20C44 16.6863 41.3137 14 38 14L37 14L37 29C37 33.4183 33.4183 37 29 37L14 37L14 38C14 41.3137 16.6863 44 20 44L38 44Z'></path></g></svg>`; }, 1200); })" 
                title="Copy link">
                <svg class="w-5 h-5 fill-the-end-400 hover:fill-pepper-green-600" viewBox="0 0 48 48">
